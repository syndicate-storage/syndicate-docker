...
RUN tar zxvf hadoop-0.20.2-cdh3u5.tar.gz && mv hadoop-0.20.2-cdh3u5 hadoop

# H-Syndicate
RUN wget -O h-syndicate.zip https://github.com/syndicate-storage/H-Syndicate/archive/master.zip
RUN unzip h-syndicate.zip && mv H-Syndicate-master h-syndicate
...
RUN wget -O $HADOOP_HOME/lib/guava-11.0.2.jar http://central.maven.org/maven2/com/google/guava/guava/11.0.2/guava-11.0.2.jar
